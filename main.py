...
def eval_policy(policy, env_name, seed, eval_episodes=50):
	...
	print("---------------------------------------")
	scipy.io.savemat("TD3_1.mat",{'rewards':rewards_plot,'d_rewards':d_rewards_plot,'Q_values':Q_plots,'surv_time':time_plot,'states':states,'rewards':rewards})
...
if __name__ == "__main__":
	...
	parser.add_argument("--policy_noise", default=0.4)              # Noise added to target policy during critic update
	parser.add_argument("--noise_clip", default=0.8)                # Range to clip target policy noise
