function [output]= stdshade(amatrix,alpha,acolor,F,smth)
...
astd = nanstd(amatrix,[],1)/2; % to get std shading
...
hold on;output=plot(F,amean,'Color',acolor,'linewidth',1.5); %% change color or linewidth to adjust mean line
