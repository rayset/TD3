...
def eval_policy(policy1, policy2, env_name, seed, eval_episodes=200):
	eval_env2 = gym.make("gym_foo:foo-v1")
	eval_env1 = gym.make("first_task_0:ft0-v0")
	eval_env1.seed(seed+100)
	eval_env2.seed(seed+100)

	avg_reward = 0.
	for _ in range(eval_episodes):
		discounted_reward=0
		state, done = eval_env1.reset(), False
		#states.append(np.zeros((1,0)))
		#eval Q error
		...
		while i<=150:
			...
			if i>99:
				...
				states.append(np.append(state,0))
			#print(reward)
