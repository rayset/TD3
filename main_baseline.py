...
def eval_policy(policy, env_name, seed, eval_episodes=100):
	...
	print("---------------------------------------")
	scipy.io.savemat("TD3_3.mat",{'rewards':rewards_plot,'d_rewards':d_rewards_plot,'Q_values':Q_plots,'surv_time':time_plot,'states':states,'rewards':rewards})
...
if __name__ == "__main__":
	...
	parser.add_argument("--policy_freq", default=1.25, type=int)       # Frequency of delayed policy updates
